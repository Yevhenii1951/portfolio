...
export function CrestLogo({ className }: IconProps) {
  return (
    <svg viewBox="0 0 64 64" className={className} aria-hidden="true">
      <path
        d="M32 4 6 14v14c0 14.6 10.4 26 26 32 15.6-6 26-17.4 26-32V14L32 4Z"
        fill="none"
        stroke="currentColor"
        strokeWidth="2"
      />
...
export function MailSend({ className }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
